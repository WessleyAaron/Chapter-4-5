...
int main()
{
	...
	std::string userInputSide, userInputTriangleShape, userRepeatChoice;
	...
	do
	{
		...
		std::cout << "Would you like to solve another triangle?" << std::endl;
		std::cin >> userRepeatChoice;
	} 
	
	while (userRepeatChoice == "yes" || userRepeatChoice == "yes");

	std::cout << "Goodbye" << std::endl;

	/*if (userRepeatChoice == "yes" || userRepeatChoice == "Yes")
	{
		main();
	}
